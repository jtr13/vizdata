...
The tables below provide detailed information about datasets in R packages. The complete list of output columns is as follows. Columns not initially visible can be viewed by clicking the `Column Visibility` button.
...
show <- function(packagename) {
  ...
  datacat::data_xray(packagename, 
    ...
    DT::datatable(escape = FALSE, filter = 'top',
                  options = list(columnDefs = list(list(targets = c(4, 11), 
                                                        visible = FALSE)),
